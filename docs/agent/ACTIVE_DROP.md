...
pr: https://github.com/gavinlohnes/neo-beyond-lohnes/pull/49
...
for this Drop live in `docs/agent/drops/FACTORY-AUTOPILOT-001.md` — this file is a pointer, not a copy.
